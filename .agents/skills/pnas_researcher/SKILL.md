...
3. **Fetch Abstracts:** 
   For each of the top 5 papers, use the `firecrawl_scrape` tool to fetch its dedicated abstract page on the PNAS website to get the full abstract text and DOI.
4. **Format Output:** 
